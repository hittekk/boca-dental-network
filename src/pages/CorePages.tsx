...
export function ServicesHubPage() {
  const breadcrumbSchema = usePageMeta({
    ...
    description: 'Complete dental care at 9 Las Vegas locations — general, cosmetic, implants, orthodontics, oral surgery, pediatric, sedation, periodontal and more. Every specialist in-house.',
    url: `${DOMAIN}/services/`,
