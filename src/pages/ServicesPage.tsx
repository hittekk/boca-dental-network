...
export function ServicesHubPage() {
  ...
  const SPOTLIGHTS = [
    ...
    { slug: 'orthodontics',       label: 'Invisalign & Braces', eyebrow: 'Clear Aligners', stat: '6mo', statLabel: 'Avg. results',  desc: 'Clear aligners and traditional braces overseen by Dr. Kelcey Loveland. Teen and adult programs. Results in as little as 6 months.' },
