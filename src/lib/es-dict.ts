...
export const ES: Record<string, string> = {
  ...
  "Dr. Dannels founded Boca Dental & Braces with one goal: give every Las Vegas family access to consistent, high-quality dental care regardless of ZIP code or budget. He oversees clinical standards across all 9 locations and personally sees patients at Russell & Eastern and our newest Beltway Marketplace clinic. He is a member of the American Dental Association and the Nevada Dental Association.": "El Dr. Dannels fundó Boca Dental and Braces con un objetivo: dar a cada familia de Las Vegas acceso a una atención dental constante y de alta calidad sin importar el código postal o el presupuesto. Supervisa los estándares clínicos en las 9 clínicas y atiende personalmente a pacientes en Russell & Eastern y en nuestra clínica más nueva, Beltway Marketplace. Es miembro de la American Dental Association y la Nevada Dental Association.",
  "Dr. Loveland personally reviews and approves every Invisalign treatment plan across the Boca Dental & Braces network. A Diamond+ Invisalign provider, she completed her specialty residency focused on digital workflow and clear aligner therapy, and runs Invisalign Teen programs across the practice. She serves on the orthodontic faculty advisory committee at the Nevada State Dental Association.": "La Dra. Loveland revisa y aprueba personalmente cada plan de tratamiento de Invisalign en toda la red de Boca Dental and Braces. Proveedora Diamond+ de Invisalign, completó su residencia de especialidad enfocada en el flujo de trabajo digital y la terapia con alineadores transparentes, y dirige los programas Invisalign Teen en toda la práctica. Forma parte del comité asesor de la facultad de ortodoncia en la Nevada State Dental Association.",
  "Dr. Calder completed a four-year oral and maxillofacial surgery residency at UCSF Medical Center and is licensed in IV sedation. He performs all surgical procedures at Boca — wisdom teeth, implant placement, bone grafting, and frenectomy — and has lectured nationally on minimally invasive implant placement.": "El Dr. Calder completó una residencia de cuatro años en cirugía oral y maxilofacial en el UCSF Medical Center y está certificado en sedación intravenosa. Realiza todos los procedimientos quirúrgicos en Boca — muelas del juicio, colocación de implantes, injertos óseos y frenectomía — y ha dado conferencias a nivel nacional sobre la colocación de implantes mínimamente invasiva.",
